...
@section('content')
    <h2 class="sub-header">Ürün Kayıt Formu</h2>
    <form action="{{ route('yonetim.urun.kaydet' , @$entry->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="checkbox">
            <label>
                ...
                <input type="checkbox" name="goster_one_cikan" value="1" {{old('goster_one_cikan',$entry->detay->goster_one_cikan) ? 'checked' : ''}}> Öne Çıkan Ürünlerde Göster
            </label>
        </div>
        <div class="checkbox">
            <label>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <select style="width: 400px;" name="kategoriler[]" id="kategoriler" multiple>
