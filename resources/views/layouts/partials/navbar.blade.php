        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <form class="navbar-form navbar-left" action="{{route('urun_ara')}}" method="post">
                    {{csrf_field()}}<!--post işleminin çalışmasını engellendiği için bu kod kullanılır.Güvenlik amacıyla-->
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @guest()<!--oturum açmayan kullanıcıların görmesini istediğimiz alanları görmesini sağlar-->
                    <li><a href="{{route('kullanici.oturumac')}}">Oturum Aç</a></li>
                    <li><a href="{{route('kullanici.kaydol')}}">Kaydol</a></li>
                    @endguest
                    @auth()<!--oturum açan kullanıcıların görmesini istediğimiz alanları görmesini sağlar-->
                    <li class="dropdown">
