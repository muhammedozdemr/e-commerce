...
|
*/
Route::group(['prefix'=>'yonetim','namespace'=>'Yonetim'],function(){ //namespace ile Yonetim klasöründeki dosyayı çalıştıracaktır.
    Route::redirect('/','/yonetim/oturumac');

    Route::match(['get','post'],'/oturumac','KullaniciController@oturumac')->name('yonetim.oturumac');//birden fazla method tipine göre sayfayı açacaktır.
...
Route::group(['prefix'=>'sepet'],function(){
    ...
    Route::delete('/kaldir/{rowid}','SepetController@kaldir')->name('sepet.kaldir');//silme için
    Route::delete('/bosalt','SepetController@bosalt')->name('sepet.bosalt');//silme için
...
Route::group(['middleware'=>'auth'],function(){
    Route::get('/siparisler','SiparisController@index')->name('siparislar');
    Route::get('/siparisler/{id?}','SiparisController@detay')->name('siparis');
});


Route::group(['prefix'=>'kullanici'],function(){//prefix fonksiyonu ile önündeki değeri gruplamak
...
Route::get('/test/mail',function (){
    $kullanici=\App\Kullanici::find(1);//1 numaralı kullanıcı
